...
namespace LuaWorldObject
{
    ...
    int GetCreaturesInRange(lua_State* L, WorldObject* obj)
    {
        ...
        Eluna::WorldObjectInRangeCheck checker(false, obj, range, TYPEID_UNIT, entry);
    ...
    int GetGameObjectsInRange(lua_State* L, WorldObject* obj)
    {
        ...
        Eluna::WorldObjectInRangeCheck checker(false, obj, range, TYPEID_GAMEOBJECT, entry);
    ...
    int GetWorldObject(lua_State* L, WorldObject* obj)
    {
        ...
        sEluna->Push(L, ElunaGetWorldObject(*obj, guid));
        return 1;
    }

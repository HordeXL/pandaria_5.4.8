...
namespace LuaCreature
{
    ...
    {
        sEluna->Push(L, creature->GetLootRecipient() != nullptr);
        return 1;
    }
    ...
    int GetAITarget(lua_State* L, Creature* creature)
    {
        ...
        //    targetList.sort(WoWSource::ObjectDistanceOrderPred(creature));
    ...
    {
        sEluna->Push(L, creature->GetUInt32Value(UNIT_FIELD_NPC_FLAGS));
        return 1;
    }

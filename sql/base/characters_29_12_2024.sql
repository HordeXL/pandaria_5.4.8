...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`characters` /*!40100 DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci */;
...
(1,29,1677956209,1678005967,0,300000000,15000000,0),

(2,33,1677956148,1678013922,0,300000000,15000000,0),

(3,68,1677956123,1678088189,0,300000000,15000000,0),

(4,148,1677956195,1678111649,0,600000000,30000000,0),

(5,140,1677956135,1678076489,0,600000000,30000000,0),

(6,133,1677956182,1678100659,0,600000000,30000000,0),

(7,60,1677956218,1678106095,0,300000000,15000000,0),

(8,126,1677956196,1677997543,0,600000000,30000000,0),

(9,180,1677956137,1678119990,0,300000000,15000000,0),

(10,52,1677956172,1678093186,0,300000000,15000000,0),

(11,169,1677956165,1678024659,0,300000000,15000000,0),

(12,102,1677956174,1678090095,0,30000,10000,0);
...
CREATE TABLE `guild_member` (
  ...
  `first_prof_recipes` text CHARACTER SET ascii COLLATE ascii_general_ci,
  ...
  `second_prof_recipes` text CHARACTER SET ascii COLLATE ascii_general_ci,
...
(20001,1678532400,'NextArenaPointDistributionTime'),

(20002,1678560756,'NextWeeklyQuestResetTime'),

(20003,1677985200,'NextBGRandomDailyResetTime'),

(20004,0,'cleaning_flags'),

(20006,1677985200,NULL),

(20007,1680296400,NULL),
